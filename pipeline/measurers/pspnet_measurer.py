...
from pipeline.models.pspnet import PSPNet, build_water_model, build_food_model
...
class LevelEstimator:
    ...
    def estimate_water(
        ...
        """
        mask = self._segment(self.water_model, frame_bgr, self.water_size)
        ...
        if pct == NO_CONTAINER_SENTINEL:
            ...
            return NO_CONTAINER_SENTINEL, "CRITICAL", mask
    ...
    def estimate_food(
        ...
        Returns:
            ...
            mask   : (H, W) uint8 segmentation mask
        """
        mask = self._segment(self.food_model, frame_bgr, self.food_size)
        pct  = mask_to_fill_pct(
            mask,
